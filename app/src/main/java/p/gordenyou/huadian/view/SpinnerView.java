...
public class SpinnerView extends LinearLayout {
    ...
    public void setSpinnerList(Context context, String[] list) {
        ArrayAdapter spinnerAdapter = new ArrayAdapter(context, R.layout.support_simple_spinner_dropdown_item, list);
    ...
    public void setSpinnerList(Context context, int id) {
        ArrayAdapter spinnerAdapter = new ArrayAdapter(context, R.layout.support_simple_spinner_dropdown_item, context.getResources().getStringArray(id));
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(spinnerAdapter);
    }
